...
function AddEmissionFactorModal({ show, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      alert("Unable to create emission factor.");
    }
  };
...
export default AddEmissionFactorModal;
